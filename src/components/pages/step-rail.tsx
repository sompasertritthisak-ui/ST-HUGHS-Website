      ...
      {steps.map((step, i) => (
        <Reveal key={step.title} as="li" delay={i * 40} className="relative grid gap-3 pb-12 pl-12 last:pb-0 md:grid-cols-12 md:gap-8">
          ...
          <div className="md:col-span-4">
            {numbered ? <span className="font-mono text-[0.6875rem] uppercase tracking-[0.16em] text-gold-soft">{step.code ?? String(i + 1).padStart(2, "0")}</span> : null}
          ...
          <div className="md:col-span-8">
            ...
            {step.href ? (
              <Link href={step.href} className="group mt-4 inline-flex items-center gap-2 text-[0.9375rem] text-gold-soft">
